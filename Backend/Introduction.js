...
//just simply type node in terminal and you will enter node repl and .exit to exit or ctrl c
//node allows us to use js in our own computer which was not possible earlier.
//earlier we wrote js code but can only see it running in browser . node empowers us to use js in our own system , asynchronously .
//ex write console.log("hello"); and now instead of going to browser to see it working . open terminal and write node filename.js and enter
